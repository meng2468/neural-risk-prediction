...
class BaseRecurrent(nn.Module):
    def __init__(self):
        ...
        self.recurrent = nn.RNN(input_size=53, hidden_size=self.hidden_size)
...
class LayeredRecurrent(nn.Module):
    def __init__(self):
        ...
        self.hidden_size = 300
        self.recurrent = nn.RNN(input_size=53, hidden_size=self.hidden_size, num_layers=3, dropout=.2)
        self.final = nn.Linear(in_features=self.hidden_size,out_features=1)
        self.sigmoid = nn.Sigmoid()
...
class BaseLSTM(nn.Module):
    def __init__(self):
        ...
        self.hidden_size=300
        self.lstm = nn.LSTM(input_size=53, hidden_size=self.hidden_size)
        self.final = nn.Linear(in_features=self.hidden_size, out_features=1)
        self.sigmoid = nn.Sigmoid()
...
class BaseGRU(nn.Module):
    def __init__(self):
        ...
        self.hidden_size=300
        self.lstm = nn.GRU(input_size=53, hidden_size=self.hidden_size)
        self.final = nn.Linear(in_features=self.hidden_size, out_features=1)
        self.sigmoid = nn.Sigmoid()
